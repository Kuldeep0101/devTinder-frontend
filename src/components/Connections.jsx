...
const Connections = () => {
    ...
    if (connections.length === 0) {
        return <h1 className="text-center text-2xl font-bold mt-10">No connections found!!</h1>;
    }
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex justify-evenly p-6 border-t border-gray-200">
                                <button className="btn btn-outline btn-success flex-1 mx-2 rounded-full font-semibold transition-all duration-300 hover:scale-105">
                                    Interested
                                </button>
                                <button className="btn btn-outline btn-warning flex-1 mx-2 rounded-full font-semibold transition-all duration-300 hover:scale-105">
                                    Ignore
                                </button>
                            </div>
                        </div>
